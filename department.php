...
<?php
$department_link = $_REQUEST['to'];
$department_link = str_replace("%26","&",$department_link);
$criteria = $department_link;

#Defite string of request to your from DB:
$YOUR_PROPERTIES = 
$stid = oci_parse($conn, "SELECT ".$YOUR_PROPERTIES. "WHERE DEPTNAME='" . $department_link .);
oci_execute($stid);
